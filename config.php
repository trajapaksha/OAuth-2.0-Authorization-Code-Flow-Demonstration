...
//function to get Access token
    ...
    {
        $url = "https://www.facebook.com/dialog/oauth?response_type=code&client_id=$client_id&redirect_uri=$redirect_url&scope=public_profile%20email"; 
    ...
    function get_user_basics($access_token,$user_id)
    {
        ...
        $requestContent = array('method'=>'GET','header'=>'Authorization:Bearer '.$access_token ,'content'=>$buildParam);
        $reqcontex = stream_context_create(array('http'=>$requestContent));
        $resultmail = file_get_contents('https://graph.facebook.com/v3.0/'.$user_id.'?fields=email,picture',false,$reqcontex);
